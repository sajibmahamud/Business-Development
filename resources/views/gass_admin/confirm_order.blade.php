@extends('gass_admin.gass_admin_layout')
...
<form method="post" action="{{'/gass-confirm'}}">
	{{csrf_field()}}
	...
	<div class="form-group">
		<h3>Gass</h3>
		<input type="checkbox" name="c_gass" value="gass" class="form-control" id="exampleFormControlTextarea1" rows="3"></input>
	</div><br>
