	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href=""><span>Tax Admin Panel</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								...
								<span class="caret"></span>{{Session::get('tax_admin_name')}}
							</a>
							<ul class="dropdown-menu">
								<li><a href="{{URL::to('/tax-logout')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">	
						...
						<li><a href="{{URL::to('/all-tax-review')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Tax Order</span></a></li>

						<li><a href="{{URL::to('/tax-manage')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage</span></a></li>
