@extends('tax_admin.tax_admin_layout')
...
<form method="post" action="{{'/tax-confirm'}}">
	{{ csrf_field()}}
	...
	<div class="form-group">
		<h3>Tax</h3>
		<input type="checkbox" name="c_tax" value="tax" class="form-control" id="exampleFormControlTextarea1" rows="3"></input>
	</div><br>
