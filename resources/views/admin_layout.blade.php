					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								...
								<span class="caret"></span>{{Session::get('admin_name')}}
							</a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-order')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Order</span></a></li>

						<li><a href="{{URL::to('/admin-manage')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage</span></a></li>
